package com.project.Barwin_Portfolio_Backend.service;

import com.project.Barwin_Portfolio_Backend.model.MyUser;
import com.project.Barwin_Portfolio_Backend.repository.TokenRepository;
...
public class JwtService {
    ...
    private String generateToken(MyUser user, long expireTime) {
        String token = Jwts
                .builder()
